...
export const HeroSection = (): React.ReactElement => {
  return (
    <div className="heroSection relative" style={{
      ...
      <div className="absolute bottom-0 hidden md:block rounded-tl-[14px] rounded-tr-[14px] right-[10%] left-[10%] xl:right-[25%] xl:left-[25%] border-l-[10px] border-r-[10px] border-t-[10px] border-[rgba(136,140,143,0.8)] z-10">
