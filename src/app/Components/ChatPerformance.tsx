                    ...
                    <div className="lg:hidden mt-4 w-full rounded-[5px] p-3 border-[3px] border-[#383E4E33]">
                      ...
                      <div className="mt-4">
                        <motion.div
                          ...
                          className="max-w-[280px] sm:max-w-full font-medium text-[14px] sm:text-[16px] leading-[20px] sm:leading-[24px] text-[#000000CC] font-['Inter'] text-left ml-[5px]"
                        >
                        ...
                        <div className="mt-[10px] flex">
                          <FilledButton
                            ...
                            className="rounded-[8px] w-[141px] h-10 text-white text-[14px] sm:text-[16px] text-center font-bold bg-[#FF4206] leading-4 ml-[5px]"
                            onClick={() => {}}
                          />
                        </div>
                      </div>
